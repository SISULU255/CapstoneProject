...
st.markdown("""
Predict monthly temperature and rainfall in Tanzania using historical climate data (2000-2020)
""")
...
# Main content
if predict:
    # Prepare input data (month number only)
    month_num = month[0]
...
st.markdown("""
---
*Note: Predictions are based on historical data from 2000-2020. For educational purposes only.*
""")
